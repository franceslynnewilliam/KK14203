...
class FormPanel extends JPanel implements ActionListener, ItemListener{
   ...
   public FormPanel(){   
      ...
      String[] courses={"[Select]", "KP14203 OOP", "KT14203 CAO", "KT14403 Discrete Structures"};      
      ...
      b_submit.addActionListener(new ActionListener(){  
        ...
        //show dialog message if input is succesfully saved
               JOptionPane.showMessageDialog(null, "Congratulations! You have successfully submit the course evaluation form for " + code_selection + " !");
             }
         }  
      });
...
class MenuActionListener implements ActionListener {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      int confirmed = JOptionPane.showConfirmDialog(null, "Are you sure you want to exit?", "Select an option",
