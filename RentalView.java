...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//-------------------------------------------------setting PANEL and LABELS for Welcome section
	   ...
	   ImageIcon titleImage = new ImageIcon("../images/logo2.GIF");
		titleL = new JLabel(titleImage);
		titleL.setBounds(100, 40, 310, 300);
		mainP.add(titleL);
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("../images/bezza.GIF");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("../images/axia.GIF");
	...
	//-----------------------------------TEXT AREA for pick a car putting details for car when we click buttons over top
		...
		carDetailsTA.setText("Select a car");
	...
	private class firstCarButton implements ActionListener{ //when its clicked show up the car detail of Van
		...
		carDetailsTA.setText("Brand: Toyota Hiace\nPlate #: SAB 9511 C\nType: Van\nModel: 2014\nColor: White\nRental Price: MYR550.00\n\n- Used for tourists, family \nuse, business purpose. \nThe Vans capacity can \nhold onto 10 persons \nexcluding the driver.");
	...
	private class thirdCarButton implements ActionListener{ //button to show Taxi details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Perodua Bezza\nPlate #: SYC 698 Q\nType: Sedan\nModel: 2016\nColor: Sugar Brown\nRental Price: MYR250.00\n\n- Malaysia's famous \ntransport nation that can be used \nprivately.Tourists can \nexpernience riding on \nthis type of car and \nits daily use of commuting \nto places.");
	...
	private class finalStepButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("Car1")) { //passing the pick-up details to car details class and final transactions.
				...
				String carType = "Van", carModel = "2013";
				double carPrice = 550.00;
				...
				String carType = "Pick-up", carModel = "2017";
				...
				String carType = "Sedan", carModel = "2016";
				...
				String carType = "Hacthback", carModel = "2015";
				double carPrice = 150.00;
